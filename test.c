...
void	test(char const *fmt, ...)
{
	...
	{
		ft_printf("%{red}Failed Test %d:%{eoc}\n", i);
		printf("Format: [\"%s\"]\n", fmt);
		printf("Yours: [%s]\n", mine);
		printf("Libc : [%s]\n", libc);
		errors++;
	...
	if (pfret != ftret)
	{
		ft_printf("%{red}Failed Test %d Return Value%{eoc}\n", i);
		printf("Format: [\"%s\"]\n", fmt);
...
int		main(void)
{
	...
	// str1 = ft_strnew(100);
	// str2 = ft_strnew(100);
	// snprintf(str1, 14, "Hello world %s, you are number %d\n", "Giaco" ,5);
	// ft_snprintf(str2, 14, "Hello world %s, you are number %d\n", "Giaco" ,5);
	// snprintf(str1, 1, "Hello world %s, you are number %d\n", "Giaco" ,5);
	// ft_snprintf(str2, 1, "Hello world %s, you are number %d\n", "Giaco" ,5);
	// printf("Libc: %s\n", str1);
	// printf("Mine: %s\n", str2);
	// ft_printf("%{redy} %s Hello %d %{eoc}%s", "hello", 42 , "hello");
